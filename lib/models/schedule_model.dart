class ScheduleModel {
  ...
  factory ScheduleModel.fromFirestore(Map<String, dynamic> data) {
    return ScheduleModel(
      ...
      color: data['color'],
      fiveMinutesBefore: data['five_minutes_before'] ?? false,
      tenMinutesBefore: data['ten_minutes_before'] ?? false,
      thirtyMinutesBefore: data['thirty_minutes_before'] ?? false,
      oneHourBefore: data['one_hour_before'] ?? false,
      threeHoursBefore: data['three_hours_before'] ?? false,
      sixHoursBefore: data['six_hours_before'] ?? false,
      twelveHoursBefore: data['twelve_hours_before'] ?? false,
